...
final class Version20210429123802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE flight (id INT NOT NULL, departure_id INT NOT NULL, arrival_id INT NOT NULL, flight_number VARCHAR(45) NOT NULL, schedule TIME(0) WITHOUT TIME ZONE NOT NULL, price DOUBLE PRECISION NOT NULL, reduction BOOLEAN NOT NULL, PRIMARY KEY(id))');
